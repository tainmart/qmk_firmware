...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split(/* Base */
        KC_HOME,   KC_GESC,    KC_Q,   KC_W,      KC_E,     KC_R,    KC_T,    KC_Y,   KC_U,     KC_I,   KC_O,    KC_P,  KC_LBRC,  KC_RBRC, KC_BSPC,
         KC_END,    KC_TAB,    KC_A,   KC_S,      KC_D,     KC_F,    KC_G,    KC_H,   KC_J,     KC_K,   KC_L, KC_SCLN, KC_QUOTE, KC_ENTER,
        KC_PGUP,   KC_LSFT,    KC_Z,   KC_X,      KC_C,     KC_V,    KC_B,    KC_N,   KC_M, KC_COMMA, KC_DOT, KC_SLSH,  KC_RSFT,    MO(1),
        KC_PGDN,   KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE, KC_SPACE, KC_RALT, KC_RCTL, MO(2)),
    ...
    [2] = LAYOUT_split(
          RESET,   KC_TRNS, KC_TRNS,   KC_UP,  KC_TRNS, KC_TRNS, KC_TRNS,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6, KC_TRNS, KC_DEL,
        KC_TRNS,   KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, KC_TRNS,
